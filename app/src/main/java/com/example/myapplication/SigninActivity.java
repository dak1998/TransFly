...
import com.example.myapplication.utils.Redirector;
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()) {
                    ...
                    try {
                        ...
                        Toast.makeText(SigninActivity.this, "Invalid Authentication Credential", Toast.LENGTH_SHORT).show();
                    } catch (FirebaseAuthUserCollisionException e) {

                        Toast.makeText(SigninActivity.this, "Your email is already registered with another Social Media Account. Kindly use that account to login", Toast.LENGTH_LONG).show();
                    } catch (Exception e) {

                        Toast.makeText(SigninActivity.this, "Cannot Login due to " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
